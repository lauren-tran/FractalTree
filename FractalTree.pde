...
public void draw(){   
  ...
  branch(250,300,100,3*Math.PI/2);
}
public void branch(int x,int y, double branchLength, double angle){   
  ...
  if(branchLength > smallestBranch){
    stroke(50, 155, 44);
    branch(endX1, endY1, branchLength-5, angle1);
    branch(endX2, endY2, branchLength-5, angle2);
    branch(endX3, endY3, branchLength-5, angle3);
  }
}